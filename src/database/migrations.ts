              ...
              (_, { rows }) => {
                ...
                if (currentVersion < CURRENT_VERSION) {
                  ...
                  if (currentVersion < 2) {
                    ...
                    tx.executeSql('CREATE INDEX IF NOT EXISTS idx_transactions_date ON transactions(date)');
                    ...
                    tx.executeSql('CREATE INDEX IF NOT EXISTS idx_categories_type ON categories(type)');
                    ...
                    tx.executeSql('CREATE INDEX IF NOT EXISTS idx_budgets_category ON budgets(category_id)');
                    tx.executeSql('CREATE INDEX IF NOT EXISTS idx_budgets_period ON budgets(period)');
